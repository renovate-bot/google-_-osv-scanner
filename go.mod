...
require (
	deps.dev/api/v3 v3.0.0-20250109005846-cc10affbfdb9
	deps.dev/util/maven cc10affbfdb9
	deps.dev/util/resolve cc10affbfdb9
	deps.dev/util/semver cc10affbfdb9
	...
	github.com/google/osv-scalibr 032e218c9f26
